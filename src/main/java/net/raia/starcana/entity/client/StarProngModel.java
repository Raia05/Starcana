...
public class StarProngModel extends Model {
	private final ModelPart sword;

	public StarProngModel(ModelPart root) {
    ...
    public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData sword = modelPartData.addChild("sword", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 27.0F, 0.0F));
